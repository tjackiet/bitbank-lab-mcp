...
{% hint style="info" %}
手数料の詳細（3カテゴリの分類、信用レート未提供時の概算など）は GitHub の [docs/private-api.md](https://github.com/tjackiet/bitbank-genesis-mcp-server/blob/main/docs/private-api.md) を参照してください。
{% endhint %}
